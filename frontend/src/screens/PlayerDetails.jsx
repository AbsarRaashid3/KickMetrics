...
import { BarChart, RadarChart, LineChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Line, Bar, XAxis, YAxis, Tooltip, CartesianGrid, ResponsiveContainer } from "recharts";
    ...
    <Row className="my-6">
      ...
      <Accordion defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="5">
          ...
          <Accordion.Body>
            <Row>
              {[pacData, shoData, pasData, driData, defData, phyData].map((data, index) => (
