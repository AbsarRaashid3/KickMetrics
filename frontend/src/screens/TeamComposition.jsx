...
const TeamCompositionScreen = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <form style={styles.form} onSubmit={generateTeam}>
        ...
        <button type="submit" className="football-button" >Generate Team</button>
      </form>
            ...
            <div style={styles.pitch}>
              ...
              <div style={{ ...styles.position, ...baseCoordinates.GK }}>
                ...
                <div style={styles.playerName}>
                  {teamData.starting_team.GK.name || teamData.starting_team.GK.name}
                </div>
  ...
  <h2>Team Insights</h2>
  <p style={{ ...styles.summary, whiteSpace: "pre-wrap" }}>
    {teamData.basic_summary}
  </p>
</div>
...
summary: {
  ...
  modalButton: {
    ...
    cursor: "pointer",
  marginRight: "10px",
  background: "linear-gradient(135deg, #223a6a,rgb(94, 93, 93), #670d0d)",
